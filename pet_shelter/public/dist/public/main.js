...
var routes = [
    ...
    { path: ':id', component: _details_details_component__WEBPACK_IMPORTED_MODULE_5__["DetailsComponent"] }
];
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJjcmVhdGUvY3JlYXRlLmNvbXBvbmVudC5jc3MifQ== */"
...
module.exports = "<button type=\"button\" class=\"btn btn-primary mt-2 mb-2\" (click)=\"goHome()\">Home</button>\n<h4>Know of a pet needing a home?</h4>\n<p class='text text-danger' *ngFor=\"let e of errors\">{{ e }}</p>\n<form (submit)= \"onSubmit()\">\n    <p>Pet Name: <input type=\"text\" name=\"pet.name\" [(ngModel)]=\"pet.name\" class=\"form-control\"></p>\n    <p>Pet Type: <input type=\"text\" name=\"pet.type\" [(ngModel)]=\"pet.type\" class=\"form-control\"></p>\n    <p>Description: <input type=\"text\" name=\"pet.description\" [(ngModel)]=\"pet.description\" class=\"form-control\"></p>\n    <h6>Skills:</h6>\n    <p>Skill 1: <input type=\"text\" name=\"pet.skill1\" [(ngModel)]=\"pet.skill1\" class=\"form-control\"></p>\n    <p>Skill 2: <input type=\"text\" name=\"pet.skill2\" [(ngModel)]=\"pet.skill2\" class=\"form-control\"></p>\n    <p>Skill 3: <input type=\"text\" name=\"pet.skill3\" [(ngModel)]=\"pet.skill3\" class=\"form-control\"></p>\n\n    <button type=\"submit\" class=\"btn btn-outline-success\">Submit</button>\n    <button type=\"button\" class=\"btn btn-outline-danger ml-3\" (click)=\"goHome()\">Cancel</button>\n  </form>\n"
...
var CreateComponent = /** @class */ (function () {
    ...
    CreateComponent.prototype.onSubmit = function () {
        var _this = this;
        var observable = this._httpService.createPet(this.pet);
...
var DetailsComponent = /** @class */ (function () {
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        ...
        this._route.params.subscribe(function (params) {
            var observable = _this._httpService.findPet(params['id']);
            observable.subscribe(function (data) {
                _this.pet = data;
            });
        });
    };
    DetailsComponent.prototype.deletePet = function (id) {
        var _this = this;
...
module.exports = "<button type=\"button\" class=\"btn btn-primary mt-2 mb-2\" [routerLink]=\"['/']\">Home</button>\n<h4>Edit this pet</h4>\n<p class='text text-danger' *ngFor=\"let e of errors\">{{ e }}</p>\n<div *ngIf=\"pet\">\n  <form (submit)= \"editPet()\">\n    <p>Pet Name: <input type=\"text\" name=\"pet.name\" [(ngModel)]=\"pet.name\" class=\"form-control\"></p>\n    <p>Pet Type: <input type=\"text\" name=\"pet.type\" [(ngModel)]=\"pet.type\" class=\"form-control\"></p>\n    <p>Description: <input type=\"text\" name=\"pet.description\" [(ngModel)]=\"pet.description\" class=\"form-control\"></p>\n    <h5>Skills:</h5>\n    <p>Skill 1: <input type=\"text\" name=\"pet.skill1\" [(ngModel)]=\"pet.skill1\" class=\"form-control\"></p>\n    <p>Skill 2: <input type=\"text\" name=\"pet.skill2\" [(ngModel)]=\"pet.skill2\" class=\"form-control\"></p>\n    <p>Skill 3: <input type=\"text\" name=\"pet.skill3\" [(ngModel)]=\"pet.skill3\" class=\"form-control\"></p>\n\n    <button type=\"submit\" class=\"btn btn-outline-success\">Submit</button>\n    <button type=\"button\" class=\"btn btn-outline-danger ml-3\" [routerLink]=\"['/']\">Cancel</button>\n  </form>\n</div>"
...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.editPet = function () {
        var _this = this;
        var observable = this._httpService.updatePet(this.pet._id, this.pet);
        observable.subscribe(function (data) {
            _this.goHome();
        });
    };
...
module.exports = "<h5>These pets are looking for a home!</h5>\n <button type=\"button\" class=\"btn btn-outline-primary mt-2 mb-2\" (click)=\"addPet()\">Add a pet to the shelter</button>\n<table class='table table-striped table-bordered table-hover'>\n  <tr>\n    <th>Name</th>\n    <th>Type</th>\n    <th>Actions</th>\n  </tr>\n  <tr *ngFor='let pet of pets'>\n    <td>\n      {{pet.name}}\n    </td>\n    <td>\n      {{pet.type}}\n    </td>\n    <td>\n      <button class='btn btn-info' [routerLink]=\"['/edit', pet._id]\">Edit</button>\n      <button class='btn btn-primary ml-3' [routerLink]=\"['/'+ pet._id]\">Details</button>\n    </td>\n  </tr>\n</table>\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.addPet = function () {
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.createPet = function (pet) {
        return this._http.post('/api/pets', pet);
    };
    HttpService.prototype.findPet = function (id) {
        return this._http.get("/api/pets/" + id);
    };
    HttpService.prototype.updatePet = function (id, pet) {
...
module.exports = __webpack_require__(/*! C:\Users\matth\Documents\School Assignments\MeanStack\pet_shelter\public\src\main.ts */"./src/main.ts");
