...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.random = function (min, max) {
        return (Math.floor(Math.random() * (min - max)) + max);
    };
    AppComponent.prototype.farm = function () {
        var newgold = this.random(2, 6);
        var observable = this._httpService.updateGold(this.id, { gold: newgold + this.gold });
    ...
    AppComponent.prototype.update = function () {
        var _this = this;
        var observable = this._httpService.showGold(this.id);
        observable.subscribe(function (data) {
            _this.gold = data.gold;
        });
    };
    AppComponent.prototype.start = function () {
        var _this = this;
        var observable = this._httpService.create(this.gold);
        observable.subscribe(function (data) {
            _this.gold = data.gold.gold;
            _this.id = data.gold._id;
        });
    };
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.create = function (gold) {
        return this._http.post('/golds', gold);
    };
    HttpService.prototype.totalGold = function () {
        return this._http.get('/golds');
    };
    HttpService.prototype.updateGold = function (id, gold) {
        return this._http.put("/golds/" + id, gold);
    };
    HttpService.prototype.showGold = function (id) {
        return this._http.get("/golds/" + id);
    };
    HttpService.prototype.restart = function () {
